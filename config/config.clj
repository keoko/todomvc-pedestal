  ...
  {:todomvc-pedestal
   {;; :build contains parameters which are passed to the build
    :build {;; :watch-files contains a list of files to watch for
            ...
            ;; the templates.
            :triggers {:html [#"todomvc_pedestal/rendering.js"]}}
    ...
    :aspects {;; Add an aspect that uses the data renderer
              ...
              :development {:uri "/todomvc-pedestal-dev.html"
                            :name "Development"
                            :out-file "todomvc-pedestal-dev.js"
                            :main 'todomvc_pedestal.start
                            :logging? true
                            :order 3}
              :fresh {:uri "/fresh.html"
                      ...
                      :order 4
                      :output-root :tools-public}
              :production {:uri "/todomvc-pedestal.html"
                           :name "Production"
                           :optimizations :advanced
                           :out-file "todomvc-pedestal.js"
                           :main 'todomvc_pedestal.start
                           :order 5}}}})
