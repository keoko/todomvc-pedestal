(ns todomvc-pedestal.start
  (:require [io.pedestal.app.protocols :as p]
            [io.pedestal.app :as app]
            [io.pedestal.app.render.push :as push-render]
            [io.pedestal.app.render :as render]
            [todomvc-pedestal.behavior :as behavior]
            [todomvc-pedestal.rendering :as rendering]))
...
(defn create-app [render-config]
  (let [;; Build the application described in the map
        ...
        ;;
        ;; The file, app/src/todomvc_pedestal/rendering.cljs contains
